    ...
    <div className="font-sans text-black bg-white p-4 w-full h-full" style={{ direction: 'rtl', textAlign: 'right' }}>
      <div className="max-w-xs mx-auto">
        ...
        <div className="grid grid-cols-1 mb-2 text-xs">
          <div>
            <h4 className="font-bold uppercase text-gray-500 text-[10px]">الأمتعة</h4>
